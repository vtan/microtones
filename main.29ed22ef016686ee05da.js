...
`,J=r.a.p`
  ...
  color: #666;
  font-size: 0.8rem;
`;function H({dispatch:e,sequences:t,selectedSequenceIndex:n,displayedAccidental:r,pitches:c,selection:a,playback:o}){s.useEffect(()=>{const t=Q(e);return window.addEventListener("keydown",t,!0),()=>window.removeEventListener("keydown",t,!0)},[]);const u=s.useCallback(t=>()=>e({type:"setSequencerSelection",selection:t}),[]),d=s.useCallback(t=>e({type:"resizeSequenceSteps",numberOfSteps:parseInt(t.target.value)}),[]),p=s.useMemo(()=>E({sequences:t,selectedSequenceIndex:n}),[t,n]),m=s.useMemo(()=>60/(4*p.secondsPerStep),[p.secondsPerStep]),[f,y]=s.useState(m),b=s.useCallback(U.throttle(t=>{e({type:"setSequenceTempo",secondsPerStep:60/t/4})},500,{leading:!1}),[]),g=s.useCallback(e=>{const t=parseInt(e.target.value);b(t),y(t)},[b]);return s.createElement(s.Fragment,null,s.createElement("div",null,s.createElement(W,null,"Steps"),s.createElement("input",{onChange:d,type:"number",min:4,max:256,value:p.steps.length})),s.createElement("div",null,s.createElement(W,null,"Tempo"),s.createElement(Y,null,f.toFixed(0)),s.createElement("input",{onChange:g,type:"range",min:40,max:200,value:f})),s.createElement(V,null,s.createElement(X,{onClick:()=>e({type:"toggleSequencerPlaying",dispatch:e})},void 0===o?"▶":"◼"),s.createElement(Z,null),s.createElement(X,{onClick:()=>function(e){e({type:"setSelectedStep",step:{type:"empty"}})}(e)},"Delete"),s.createElement(X,{onClick:()=>function(e){e({type:"setSelectedStep",step:{type:"hold"}})}(e)},"Hold")),s.createElement(ee,null,s.createElement("thead",null,s.createElement("tr",null,s.createElement("th",{key:-1}),[...Array(p.numberOfTracks)].map((e,t)=>s.createElement("th",{key:t},"Track ",t+1)))),s.createElement("tbody",null,p.steps.map((e,t)=>{const n=void 0!==a&&a.step===t,d=void 0!==o&&o.currentStepIndex===t;return s.createElement(te,{key:t,isCurrentlyPlayed:d},s.createElement(ne,{key:t},t+1),e.map((e,o)=>{const d=n&&void 0!==a&&a.track===o,p=function(e,t,n){switch(e.type){case"empty":return"_";case"pitch":const r=t[e.pitchIndex],c=l[n][r.note.nearest12EdoNote],a=i(r.note);return s.createElement(s.Fragment,null,c,s.createElement("sub",null,r.octave)," ",a);case"hold":return"|"}}(e,c,r);return s.createElement(se,{key:o,isSelected:d,onClick:u({step:t,track:o})},p)}))}))),s.createElement(J,null,"Use the keyboard to enter & delete notes, hold notes (",s.createElement("kbd",null,"↵"),"), start/stop playback (",s.createElement("kbd",null,"Space"),") and move the selection"))}const _={Backspace:()=>({type:"setSelectedStep",step:{type:"empty"}}),Delete:()=>({type:"setSelectedStep",step:{type:"empty"}}),Enter:()=>({type:"setSelectedStep",step:{type:"hold"}}),ArrowLeft:()=>({type:"moveSequencerSelection",diff:{track:-1,step:0}}),ArrowRight:()=>({type:"moveSequencerSelection",diff:{track:1,step:0}}),ArrowUp:()=>({type:"moveSequencerSelection",diff:{step:-1,track:0}}),ArrowDown:()=>({type:"moveSequencerSelection",diff:{step:1,track:0}})," ":e=>({type:"toggleSequencerPlaying",dispatch:e})},Q=e=>t=>{if(!(t.shiftKey||t.ctrlKey||t.altKey||t.metaKey)){const n=_[t.key];void 0!==n&&(t.preventDefault(),e(n(e)))}},V=r.a.div`
...
`,ie=r.a.main`
  flex: auto;
  padding: 1rem;
`;var le=n(650);Object(le.render)(s.createElement((function(){const[e,t]=s.useReducer(w,S),{openPanel:n,numberOfSubdivisions:r,displayedAccidental:c,waveform:a,notes:o,pitches:i,keys:l,keyboardOffset:u,pressedKeyIndices:d,sequences:p,selectedSequenceIndex:m,sequencerSelection:f,sequencerPlayback:y}=e;return s.useEffect(()=>A(t),[]),s.createElement(oe,null,s.createElement(R,{dispatch:t,openPanel:n}),s.createElement(ie,null,s.createElement(N,{dispatch:t,keys:l,keyboardOffset:u,numberOfSubdivisons:r,pressedKeyIndices:d}),"sequencer"===n?s.createElement(H,{dispatch:t,sequences:p,selectedSequenceIndex:m,displayedAccidental:c,pitches:i,selection:f,playback:y}):"tuning"===n?s.createElement(ce,{dispatch:t,numberOfSubdivisions:r,displayedAccidental:c,notes:o,keys:l,pressedKeyIndices:d}):"synth"===n?s.createElement(re,{dispatch:t,waveform:a}):null))}),null),document.getElementById("root"))}},[[681,1,2]]]);
//# sourceMappingURL=main.29ed22ef016686ee05da.js.map